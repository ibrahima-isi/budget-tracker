...
<template>
    <div>
        <div class="flex justify-between text-sm mb-1">
            <span class="text-gray-600 dark:text-gray-400">{{ format(depense) }} dépensés</span>
            <span class="font-medium text-gray-800 dark:text-gray-200">{{ pct }}%</span>
        </div>
        ...
        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Budget prévu : {{ format(prevu) }}</p>
    </div>
</template>
