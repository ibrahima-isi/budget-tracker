    ...
    <AuthenticatedLayout>
        ...
        <div class="py-8">
            <div class="mx-auto max-w-4xl sm:px-6 lg:px-8 space-y-6">
                ...
                <div v-if="error"   class="rounded-lg bg-red-50   px-4 py-3 text-red-700   text-sm">{{ error }}</div>
                ...
                <div class="flex gap-1 bg-gray-100 p-1 rounded-xl w-fit">
                    ...
                    <button
                        ...
                        class="px-4 py-2 rounded-lg text-sm font-medium transition"
                        :class="tab === 'currencies' ? 'bg-white shadow text-gray-900' : 'text-gray-500 hover:text-gray-700'"
                    >
                        Devises
                    </button>
                </div>
                ...
                <!-- ── TAB: General ── -->
                <div v-if="tab === 'general'" class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    <form @submit.prevent="submitSettings" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="mt-2 flex items-center gap-4">
                                ...
                                <div class="flex gap-2">
                                    <label class="cursor-pointer px-3 py-2 rounded-lg border border-gray-300 text-sm text-gray-700 hover:bg-gray-50 transition">
                                        Choisir un fichier
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <select v-model="settingsForm.language" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm">
                            ...
                            <div>
                                ...
                                <select v-model="settingsForm.default_currency" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm">
